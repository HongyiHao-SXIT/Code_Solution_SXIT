...
bool RunGradeTests() {
  ...
  success &= Expect(grade.getAccount() == "student01",
                    "Grade account should match constructor input.");
  success &= Expect(grade.getCourseCode() == "CS101",
                    "Grade course code should match constructor input.");
  success &= Expect(grade.getScore() == "95",
  ...
  success &= Expect(grade.getAccount() == "student02",
                    "Grade account setter should update the value.");
  success &= Expect(grade.getCourseCode() == "CS201",
                    "Grade course code setter should update the value.");
  success &= Expect(grade.getScore() == "88",
